...
local RANDOM_MIBAOS = {
  {Kind = g_emFabaoSpecialAbility.HitCountAddDamage, nParam1 = 15, sParam1 = "TheWholeBody", sParam2 = "FivePoison", Desc = "ทุก ๆ การโจมตีใส่ร่างจริงของผู้บำเพ็ญครบ {nParam1} ครั้ง จะทะลุโล่และสร้างความเสียหายเพิ่มเติม"},
